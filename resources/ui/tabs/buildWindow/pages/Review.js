    ...
    yelpView = Titanium.UI.createView({
        width:'128dp',
        height:'150dp',
    });
    yelpImage=Titanium.UI.createImageView({
        top:'0dp',
        image:'images/subpages/yelp.png'
    });
    ...
    yelpButton.add(yelpTitle);
    
    yelpView.add(yelpImage);
    yelpView.add(yelpButton);
    ...
    fbImage=Titanium.UI.createImageView({
        top:'0dp',
        image:'images/subpages/citysearch.png'
    });
