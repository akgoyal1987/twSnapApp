...
function createColorPicker(params) {
    ...
    var returnView = Ti.UI.createWindow({
        ...
        modal:true,
        fullscreen:false,
        backgroundColor:params.hexColor,
        borderColor:'#bbb',
        borderWidth:2.5,
        borderRadius:10,
    });
	...
	var lCrossHair = Ti.UI.createImageView({image:'images/lcrosshair.png', height:5, width:9, top:(LImage.top + LImage.height + 1)});
	...
	var hsCrossHair = Ti.UI.createImageView({image:'images/hscrosshair.gif', width:11, height:11});
	...
	var doneButton = Ti.UI.createButton({title:"Select", top: 310, width:100, height:40, left:10, bottom:10});
	...
	var cancelButton = Ti.UI.createButton({title:"Cancel", top:310, width:100, height:40, right:10, bottom: 10});
