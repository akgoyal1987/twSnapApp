    ...
    Ti.include('/libs/auth_module.js');
    ...
    function getProfileImage(){
        Ti.App.authModule = AuthModule.init({
          client_id:       "FrsxffyVFv0ciPy0h0oI9oUwd",
          client_secret:   "lOay5qyuEcpdyJJ9Eir32IkTixohPoAjniOzigKKGmvXuA9whV",
          redirect_uri:    "http://your_redirect_uri:3000/",
          auth_server_url: "hhttps://api.twitter.com/oauth/authorize"
        });
        ...
        var updateMyName = new Request({
            ...
            ext:    {              first_name: "Vito",              last_name:  "Corleone"            }
        });
